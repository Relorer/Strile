package com.example.strile.data.entities;
...
import com.example.strile.utilities.converters.DatesConverter;
...
public class Habit implements Parcelable {
    ...
    public void setGoalTime(long goalTime) {
        Date day = DateUtilities.getDateOfDayWithoutTime(new Date());
    ...
    private DateCompleted getDateCompleted(Date date) {
        final Date dateOfDayWithoutTime = DateUtilities.getDateOfDayWithoutTime(date);
        ...
        if (found == null) {
            ...
            if (dateOfDayWithoutTime.getTime() == DateUtilities.getDateOfDayWithoutTime(new Date()).getTime())
                elapsedTime = 0;
