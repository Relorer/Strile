...
public class ButtonHidingRenderer extends BaseRenderer<ButtonHidingModel, ButtonHidingHolder> {
    ...
    public ButtonHidingRenderer(OnModelChangedListener onModelChangedListener) {
    ...
    public ButtonHidingHolder createViewHolder(@Nullable ViewGroup parent) {
        return new ButtonHidingHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.button_hiding, parent, false),
